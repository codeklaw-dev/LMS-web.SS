 ...
 * the reason the page stops reading as a template: same information, a quarter
 * of the chrome, and the eye travels across rather than stopping at each border.
 */
export default function RuledColumns({ items, columns = 3, accent = false }) {
  return (
